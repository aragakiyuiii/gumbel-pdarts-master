        ...
        for i, cell in enumerate(self.cells):
            if cell.reduction:
                if self.alphas_reduce.size(1) == 1:
                    ...
                    weights = gumbel_softmax(F.log_softmax(self.alphas_reduce, dim=0), tau=temperature, hard=True,
                                             dim=0)
                else:
                ...
                if self.alphas_normal.size(1) == 1:
                    ...
                    weights = gumbel_softmax(F.log_softmax(self.alphas_normal, dim=0), tau=temperature, hard=True,
                                             dim=0)
                else:
